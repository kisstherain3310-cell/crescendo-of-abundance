...
export function Headline({ onOpenRecipe }: HeadlineProps) {
  return (
    <header className="pointer-events-none absolute inset-x-0 top-0 z-50 flex flex-col items-center px-4 pt-[max(1rem,env(safe-area-inset-top))] text-center sm:px-6 sm:pt-[min(10vh,6.5rem)]">
